...
function addTrafficLight($city,$name, $time, $enable) {
    $database = getBdd();
    $modifBD = $database->prepare('INSERT INTO trafficlight
        SET Location = :city,Name=:Name, Affluence = :Affluence, StateUp = :StateUp');
    
    $modifBD->bindValue(':city', $city);
    $modifBD->bindValue(':Affluence', $time);
    $modifBD->bindValue(':StateUp', $enable);
    $modifBD->bindValue(':Name', $name);
